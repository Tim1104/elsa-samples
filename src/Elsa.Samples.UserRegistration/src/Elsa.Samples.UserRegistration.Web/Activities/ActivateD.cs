...
{
    [ActivityDefinition(Category = "Plan", Description = "Plan a D", Icon = "fas fa-user-check", Outcomes = new[] { OutcomeNames.Done })]
    public class ActivateD : Activity
    {
        ...
        protected override async Task<ActivityExecutionResult> OnExecuteAsync(WorkflowExecutionContext context, CancellationToken cancellationToken)
        {
            ...
            Output.SetVariable("Content", prefix + "D");
            return Done();
        }
    }
}
